            ...
            <html>
                ...
                <script>
                    ...
                    $(document).ready(function(){
                        $("select[name=tipoCadastro]").change(function(){
                            var tipo = $("select[name=tipoCadastro]").val();

                            if(tipo == "usuario"){
                                var HTML = \'<input class = "form-control col-6 offset-3" type = "text" name = "email" placeholder = "E-mail"/>\';
                                $("input[name=tipoCadastro]").val("usuario");
                            }else if(tipo == "empresa"){
                                var HTML = \'<input class = "form-control col-6 offset-3" type = "text" name = "CNPJ" placeholder = "CNPJ"/>\';
                                $("input[name=tipoCadastro]").val("empresa");
                            }

                            $("#inputChange").html(HTML);
                        });
                                                    ...
                                                    <div class = "modal-content">
                                                        ...
                                                        <form action = "login.php" method = "POST" name = "login">
                                                            <div class="modal-body">
                                                                <div class = row>
                                                                    <input class = "form-control col-6 offset-3" type = "email" name = "identificacao" placeholder = "E-mail ou CNPJ">
                                                                </div>
                                            ...
                                            <div class = "modal fade" id = "modalCadastro" tabindex = "-1" role = "dialog" aria-labelledby = "modalCategoria" aria-hidden = "true">
                                                <div class = "modal-dialog" role = "document">
                                                    <div class = "modal-content">
                                                        ...
                                                        <select name = "tipoCadastro" class = "form-control col-6 offset-3">
                                                        ...
                                                        <form action = "cadastro.php" method = "POST" name = "cadastro">
                                                            <div class="modal-body">
                                                                    ...
                                                                    <input type = "hidden" name = "tipoCadastro" value = "usuario"/>
                                                            </div>
